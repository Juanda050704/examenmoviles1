...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("**** CONVOCATORIA SELECCION  brasil ****");
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    objetojugador.setPosicion(Ingresodatos.next());

                    System.out.println("Ingrese el Equipo donde juega actualmente");
                    objetojugador.setEquipo(Ingresodatos.next());

                    System.out.println("Ingrese el  numero de camiseta");
                    objetojugador.setNumerodecamiseta(Ingresodatos.nextInt());
                ...
                case 2:
                    int buscarJugador;
                    System.out.println("\nBuscar jugador");
                    System.out.print("*Ingrese el numero del jugador que buscar:");
                    buscarJugador = Ingresodatos.nextInt();
                    boolean jugadorNoEncontrado = false;
                    for (Jugador jugador : jugadores) {
                        if (jugador.getNumerodecamiseta() == buscarJugador) {
                            System.out.println("#El numero de la camisa es: " + jugador.getNumerodecamiseta());
                            ...
                            System.out.println("#El equipo donde juega es: " + jugador.getEquipo());
                ...
                case 3:
                    ...
                    for (Jugador jugador : jugadores) {
                        if (jugador.getNumerodecamiseta() == editarJugador) {
                            System.out.println("** El jugador está registrado **");
                                ...
                                switch (optionEditar) {
                                    case 1:
                                        ...
                                        for (Jugador verificarJugador : jugadores) {
                                            if (verificarJugador.getNumerodecamiseta() == nuevoNumeroCamiseta) {
                                    ...
                                    case 4:
                                        ...
                                        jugador.setPosicion(Ingresodatos.next());
                                        break;
                                    ...
                                    case 6:
                                        ...
                                        jugador.setEquipo(Ingresodatos.next());
                                        break;
                ...
                case 4:
                    System.out.println("\nLista de jugadores de brasil");
                    for (Jugador jugador:jugadores) {
                        System.out.println("**************** jugador ****************");
                        System.out.println("-El numero: " + jugador.getNumerodecamiseta());
                        System.out.println("-El nombre del jugador es: " + jugador.getNombre());
                        System.out.println("-El apellido del jugador es: " + jugador.getApellidos());
                        System.out.println("-La posicion del jugador es: "+ jugador.getPosicion());
                        System.out.println("-La edad del jugador es: " + jugador.getEdad());
                        System.out.println("-El equipo del jugador es: " + jugador.getEquipo()+"\n");
                    }
                   break;
